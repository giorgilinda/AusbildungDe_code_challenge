...
export default function NotFound() {
  // credit: https://codepen.io/gxash/pen/MjQOom
      ...
      <div className={styles.wrapper}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
          ...
          <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
            ...
            <g id="round-conf">
              <path
                className={classNames(styles.cls1, styles.circle, styles.c1)}
              ...
              />
              <path
                className={classNames(styles.cls1, styles.circle, styles.c2)}
              ...
              />
              <path
                className={classNames(styles.cls1, styles.circle, styles.c3)}
              ...
              />
              <path
                className={classNames(styles.cls1, styles.circle, styles.c4)}
              ...
              />
              <path
                className={classNames(styles.cls1, styles.circle, styles.c5)}
              ...
              />
              <path
                className={classNames(styles.cls1, styles.circle, styles.c6)}
          ...
          <g id="fortyfour" data-name="Layer 2">
            <g className={classNames(styles.four, styles.a)}>
              <rect
            ...
            <g className={classNames(styles.four, styles.b)}>
              <rect
                className={styles.cls2}
                x="1558.84"
                y="391.91"
          ...
          <g id="clock" data-name="Layer 8">
            ...
            />
            <rect
              className={classNames(styles.cls3, styles.clock_hand_1)}
              x="845"
              y="189.5"
              width="6.04"
              height="58"
            ...
            />
            <rect
              className={classNames(styles.cls3, styles.clock_hand_2)}
              x="845"
              y="209.5"
              width="6.04"
              height="38"
          ...
          <g id="bike" data-name="Layer 5">
            <path
              className={classNames(styles.cls8, styles.wheel)}
