      ...
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <ul>
            ...
            <li>
              <a
                href="https://cv-iota-beryl.vercel.app/"
                target="_blank"
                rel="noreferrer noopener"
              >
                About me
        ...
        <footer className={styles.footer}>
          <div className={styles.footer_wrapper}>
            ...
            <div>
              <h3 className="font-semibold text-gray-500 mb-[10px]">Contact</h3>
              <ul>
                <li>
                  <a href="mailto:giorgi.linda@gmail.com">
                    <svg
                    ...
                    giorgi.linda@gmail.com
                  </a>
                </li>
                <li>
                  <a href="tel:004915222538388">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                    >
                ...
                <li>
                  <a
                    href="https://github.com/giorgilinda"
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    <svg
